...
export default function Page() {
    ...
    return(
        <main>
            ...
            <audio src="audio/second.mp4" id='second'></audio>
            <audio src="audio/third.mp4" id='third'></audio>
            <div className={styles.MainText}>
            This is Kenny, you have to help us, this company is not as it seems. Unpaid workers, use of copyright material, weird experiments with AI, all of these seem to be going on underneath the surface. <br></br>
...
All that I could do is to drop hints for you before they would find out. Please, free the rest as soon as possible before it is too late. <br></br>
            ...
            <div className={styles.Questions}>
                ...
                What is the exact day that it was invented? <br></br>
            </div>
